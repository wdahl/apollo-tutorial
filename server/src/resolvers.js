...
module.exports = {
    ...
    Mutation: {
        ...
        bookTrips: async (_, { launchIds }, { dataSources }) => {
            ...
            return {
                ...
                message: results.length === launchIds.length ? 'trips booked successfully' : `the following launches couldn't be booked: ${launchIds.filter(
    ...
    Mission: {
        missionPatch: (mission, {size} = {size: 'LARGE'}) => {
            return size === 'SMALL' ? mission.missionPatchSmall : mission.missioPatchLarge
        }
    },
    Launch: {
